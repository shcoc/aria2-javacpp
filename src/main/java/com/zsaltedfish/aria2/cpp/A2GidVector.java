...
@Name("std::vector<A2Gid>") @Properties(inherit = com.zsaltedfish.aria2.prest.Aria2.class)
public class A2GidVector extends Pointer {
    ...
    public A2GidVector push_back(long value) {
        long size = size();
        resize(size + 1);
        return put(size, value);
    }
    public A2GidVector put(long value) {
        if (size() != 1) { resize(1); }
        return put(0, value);
    }
    public A2GidVector put(long ... array) {
